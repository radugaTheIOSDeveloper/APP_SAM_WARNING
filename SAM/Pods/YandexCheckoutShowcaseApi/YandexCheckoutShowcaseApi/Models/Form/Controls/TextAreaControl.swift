/// Поле для ввода произвольного текста, который может состоять из множества строк.
public struct TextAreaControl: Control {

    /// ControlProtocol
    public let type: FormType = .textarea
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard case .textarea = try container.decode(FormType.self, forKey: .type) else {

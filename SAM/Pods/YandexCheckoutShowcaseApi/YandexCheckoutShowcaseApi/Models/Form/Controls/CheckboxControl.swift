/// Чекбокс — контрол, реализующий установку флажка true/false.
public struct CheckboxControl: Control {

    /// ControlProtocol
    public let type: FormType = .checkbox
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard case .checkbox = try container.decode(FormType.self, forKey: .type) else {
